...
class particle_filter_wrap
{
    ...
    void Pose2DToTF(Eigen::Vector3d mean, ros::Time ts, Eigen::Affine3d Todometry)
    {
        ...
        // 0.0) ); tf::Quaternion q_map_odo; q_map_odo.setRPY( 0, 0,
        // Tmap_odo.rotation().eulerAngles(0, 1, 2) (2) ); tf_map_odo.setRotation( q_map_odo );
        // // // broadcast TF
    ...
    geometry_msgs::PoseArray ParticlesToMsg(
        std::vector<perception_oru::particle, Eigen::aligned_allocator<perception_oru::particle>>
            particles)
    {
    ...
    {
        /*ROS_INFO_STREAM("I have helodynes");
    ...
    void processFrame(pcl::PointCloud<pcl::PointXYZL>& cloud, ros::Time ts)
    {
