...
class particle_filter_wrap {
  ...
  void initialposeCallback(geometry_msgs::PoseWithCovarianceStamped input_init){
   ...
   void VelodyneOdomCallback(const velodyne_msgs::VelodyneScan::ConstPtr& msg,const nav_msgs::Odometry::ConstPtr& odo_in){
     ROS_INFO_STREAM("I have velodyne points");
  ...
  void processFrame(pcl::PointCloud<pcl::PointXYZL> &cloud, const nav_msgs::Odometry::ConstPtr& odo_in,  ros::Time ts){
    ...
    ROS_INFO_STREAM("I am processing the frame");
