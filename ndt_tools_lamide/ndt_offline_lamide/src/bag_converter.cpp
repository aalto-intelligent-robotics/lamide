...
int main(int argc, char **argv){
  ...
  double min_dist;
  double min_range=0.8,max_range=100;
  ...
  desc.add_options()
      ...
      ("min_range", po::value<double>(&min_range)->default_value(0.8), "minimum range used from scanner")
      ("max_range", po::value<double>(&max_range)->default_value(100), "minimum range used from scanner")
      ...
      ("sensor_time_offset", po::value<double>(&sensor_time_offset)->default_value(0.), "offset between ground_truth frame and lidar")
