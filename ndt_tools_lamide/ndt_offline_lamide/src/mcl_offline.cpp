...
#include "graph_localisation/visualization/graph_plot_localisation.h"
#include "ros/ros.h"
#include "nav_msgs/Odometry.h"
#include "ros/publisher.h"
#include "tf/transform_broadcaster.h"
#include "ndt_generic_lamide/eigen_utils.h"
//#include "ndt_mcl_lamide/3d_ndt_mcl.h"
#include "ndt_localization_lamide/3d_ndt_mcl.hpp"
#include "ndt_generic_lamide/io.h"
#include "../../graph_localisation/include/graph_localisation/visualization/graph_plot_localisation.h"
...
void filter_fov_fun(pcl::PointCloud<pcl::PointXYZL> &cloud, pcl::PointCloud<pcl::PointXYZL> &cloud_nofilter, double hori_min, double hori_max) {
...
int main(int argc, char **argv){
  ...
  for(int i=0; i<ros_bag_paths.size(); i++) {
    ...
    VelodyneBagReader<pcl::PointXYZL> vreader(velodyne_config_file,
                                             bagfilename,
    ...
    pcl::PointCloud<pcl::PointXYZL> cloud, cloud_nofilter;
    ...
    while(vreader.readMultipleMeasurements(nb_scan_msgs,cloud_nofilter,tf_scan_source,tf_gt_base,base_link_id)){
      ...
      if(counter == 1){
        ...
        NDTMapPtr curr_node = boost::dynamic_pointer_cast< NDTMapType >(graph_map->GetCurrentMapNode());
      ...
      if(visualize){
        ...
        if(counter%10==0){
          ...
          GraphMapLocalisation::GraphPlotLocalisation::plotParticleCloud(graph_map->GetCurrentNodePose(),mcl->pf.pcloud);
        }
      }
