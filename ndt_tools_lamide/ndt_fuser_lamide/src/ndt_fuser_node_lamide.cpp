...
public:
        ...
        : nb_added_clouds_(0)
    {
        ...
        {
            points2_sub_ =
                new message_filters::Subscriber<sensor_msgs::PointCloud2>(nh_, points_topic, 20);
            if (useOdometry)
            {
                odom_sub_ =
                    new message_filters::Subscriber<nav_msgs::Odometry>(nh_, odometry_topic, 200);
    ...
    void processFrame(pcl::PointCloud<pcl::PointXYZL>& cloud_in, Eigen::Affine3d Tmotion)
    {
        ...
        {
            pcl::PointXYZL pt = cloud_in.points[i];
        ...
        if (nb_added_clouds_ == 0)
        {
            ...
            else if (initPoseFromTF)
            {
                ...
                perception_oru::ndt_fuser::initSensorPose(*fuser, robot_frame,
    ...
    void points2Callback(const sensor_msgs::PointCloud2::ConstPtr& msg_in)
    {
        ...
        else
        {
            ...
            ROS_INFO_STREAM("delta from last update: " << Tm.translation().transpose() << " "
                             ...
                             const nav_msgs::Odometry::ConstPtr& odo_in)
    {
        ...
        this_odom = Eigen::Translation3d(odo_in->pose.pose.position.x, odo_in->pose.pose.position.y,
        ...
        else
        {
            ...
            // "<<Tm.rotation().eulerAngles(0,1,2)[2] << std::endl; if(Tm.translation().norm()<0.2
    ...
    void gt_callback(const nav_msgs::Odometry::ConstPtr& msg_in)
    {
        ...
        {
#ifndef NO_NDT_VIZ
            fuser->viewer->addTrajectoryPoint(gt_pose.translation()(0), gt_pose.translation()(1),
