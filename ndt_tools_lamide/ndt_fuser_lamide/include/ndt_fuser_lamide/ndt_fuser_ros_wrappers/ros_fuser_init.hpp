...
namespace ndt_fuser{
	...
	*/
	void initRobotPose(perception_oru::NDTFuserHMT& fuser, pcl::PointCloud< pcl::PointXYZL >& cloud, std::string& world_frame, std::string& robot_frame, bool preLoad=false);
	...
	*/
	void initRobotPose2D(perception_oru::NDTFuserHMT& fuser, pcl::PointCloud< pcl::PointXYZL >& cloud, std::string& world_frame, std::string& robot_frame, bool preLoad=false);
}
