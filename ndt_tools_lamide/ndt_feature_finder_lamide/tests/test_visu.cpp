...
#include "ndt_feature_lamide/NDTCornerVisu.hpp"
...
// 	ros::Publisher marker_pub_graph2 = nh.advertise<visualization_msgs::Marker>("visualization_marker_graph2", 10);
	...
	ros::Publisher ndt_map_pub= nh.advertise<ndt_map_lamide::NDTMapRGBMsg>("lastgraphmap", 10);
	...
	bool good = perception_oru::toRGBMessage(&map, mapmsg, "/world");
