...
void calculate_ICP_COV(pcl::PointCloud<pcl::PointXYZL>& data_pi, pcl::PointCloud<pcl::PointXYZL>& model_qi, Eigen::Matrix4d& transform, Eigen::MatrixXd& ICP_COV)
{
...
{
public:
    bool match(pcl::PointCloud<pcl::PointXYZL> &fixed,  pcl::PointCloud<pcl::PointXYZL> &moving,
    ...
    bool covariance( pcl::PointCloud<pcl::PointXYZL>& target,
    ...
    const pcl::PointCloud<pcl::PointXYZL>& getFinalPC() const {
        return final_;
    }

private:
    pcl::PointCloud<pcl::PointXYZL> final_;
};
