...
void filterDensity(pcl::PointCloud<pcl::PointXYZL> &rawCloud, pcl::PointCloud<pcl::PointXYZL> &pc)
{
    pcl::RadiusOutlierRemoval<pcl::PointXYZL> filter;
    filter.setRadiusSearch(0.2);
    filter.setMinNeighborsInRadius(3);
    pcl::PointCloud<pcl::PointXYZL>::Ptr pcptr(new pcl::PointCloud<pcl::PointXYZL>());
    *pcptr = rawCloud;
...
main (int argc, char** argv)
{
    ...
    pcl::PointCloud<pcl::PointXYZL> prev, thisone1, thisone, cloudFinal;
...
//	thisone1.width = thisone1.height = 0;
        ...
        reader.read<pcl::PointXYZL>(pcName,thisone);
    ...
    pcl::PointCloud<pcl::PointXYZL> cl;
    pcl::PointXYZL pt;
