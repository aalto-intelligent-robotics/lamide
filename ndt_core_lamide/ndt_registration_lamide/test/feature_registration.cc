...
public:
    ...
    //typedef pcl::KdTreeFLANN<pcl::PointXYZL> SearchMethod;
...
protected:
    ...
    computeSurfaceNormals ()
    {
        ...
        pcl::NormalEstimation<pcl::PointXYZL, pcl::Normal> norm_est;
    ...
    computeLocalFeatures ()
    {
        ...
        pcl::FPFHEstimation<pcl::PointXYZL, pcl::Normal, pcl::FPFHSignature33> fpfh_est;
...
private:
    ...
    pcl::Feature<pcl::PointXYZL, pcl::Normal>::KdTreePtr search_method_xyz_;
...
public:
    ...
    align (FeatureCloud &moving_cloud, TemplateRegistration::Result &result)
    {
        ...
        pcl::PointCloud<pcl::PointXYZL> registration_output;
...
private:
    ...
    pcl::SampleConsensusInitialAlignment<pcl::PointXYZL, pcl::PointXYZL, pcl::FPFHSignature33> sac_ia_;
...
main (int argc, char **argv)
{
    ...
    pcl::PointCloud<pcl::PointXYZL>::Ptr cloudM (new pcl::PointCloud<pcl::PointXYZL>);
    pcl::PointCloud<pcl::PointXYZL>::Ptr cloudF (new pcl::PointCloud<pcl::PointXYZL>);
    pcl::PointCloud<pcl::PointXYZL> Final, Final0, Final1;
