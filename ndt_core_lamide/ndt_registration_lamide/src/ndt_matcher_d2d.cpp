...
bool NDTMatcherD2D::match(pcl::PointCloud<pcl::PointXYZL>& target,
...
bool NDTMatcherD2D::update_gradient_hessian_local(Eigen::MatrixXd& score_gradient,
...
void NDTMatcherD2D::computeDerivativesLocal(Eigen::Vector3d& x,
                                            Eigen::Matrix3d C1,
...
int NDTMatcherD2D::MoreThuente::cstep(double& stx,
                                      double& fx,
                                      double& dx,
                                      double& sty,
                                      double& fy,
...
bool NDTMatcherD2D::covariance(pcl::PointCloud<pcl::PointXYZL>& target,
                               pcl::PointCloud<pcl::PointXYZL>& source,
                               Eigen::Transform<double, 3, Eigen::Affine, Eigen::ColMajor>& T,
                               Eigen::MatrixXd& cov)
{
