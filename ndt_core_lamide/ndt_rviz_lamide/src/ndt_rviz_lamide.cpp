...
// markers.
inline geometry_msgs::Point toPointFromPCL(const pcl::PointXYZL& p)
{
...
inline visualization_msgs::Marker markerNDTCells(
...
void markerNDTCells2(perception_oru::NDTMap& map,
                     const Eigen::Affine3d& pose,
                     int id,
                     const std::string& name,
                     visualization_msgs::Marker& m)
...
inline visualization_msgs::Marker markerCellVectorCorrespondances(
    perception_oru::NDTMap& map1,
...
inline visualization_msgs::Marker markerMeanCovariance2d(
    const Eigen::Vector3d& mean, const Eigen::Matrix3d& cov, double scale, int id, int color)
{
    visualization_msgs::Marker m;
    assignDefault(m);
    m.ns = "mean_cov";
...
visualization_msgs::Marker getMarkerLineListFromTwoPointClouds(
    const pcl::PointCloud<pcl::PointXYZL>& pc1,
    const pcl::PointCloud<pcl::PointXYZL>& pc2,
    int color,
    const std::string& ns,
