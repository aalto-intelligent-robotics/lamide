...
int main (int argc, char** argv) {
    ...
    pcl::PointCloud<pcl::PointXYZL> cloud, cloud2, cloud3;
    pcl::PointCloud<pcl::PointXYZI> outCloud;

    // lslgeneric::OctTree<pcl::PointXYZL> tr;
    // tr.BIG_CELL_SIZE = 2;
...
#if 0
    pcl::io::loadPCDFile<pcl::PointXYZL> (argv[1], cloud);
    pcl::io::loadPCDFile<pcl::PointXYZL> (argv[2], cloud2);
