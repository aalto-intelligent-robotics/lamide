...
#include <ndt_map_lamide/ndt_histogram.h>
...
namespace perception_oru{
  ...
  pcl::PointCloud<pcl::PointXYZL> NDTHistogram::getDominantDirections(int nDirections){
  ...
  void NDTHistogram::bestFitToHistogram(NDTHistogram &target, Eigen::Transform<double,3,Eigen::Affine,Eigen::ColMajor> &T, bool bound_transform)
  {
    ...
    pcl::PointCloud<pcl::PointXYZL> dominantBinsMine, dominantBinsTarget;
    ...
    */
    ...
    pcl::PointCloud<pcl::PointXYZL> mineNew, mineNew2;
            ...
            for(int b2 = 0; b2<dominantBinsTarget.points.size(); b2++)
              {
                ...
                pcl::PointCloud<pcl::PointXYZL> useMine, useTarget;
  ...
  void NDTHistogram::closedFormSolution(pcl::PointCloud<pcl::PointXYZL> &src, pcl::PointCloud<pcl::PointXYZL> &tgt, Eigen::Transform<double,3,Eigen::Affine,Eigen::ColMajor> &T){
    T.setIdentity ();
